...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  return (
    // <nav className="flex items-center justify-between bg-gray-500 p-4 fixed bottom-2 mx-4 rounded-md">
    //   <img className='w-10 h-10 rounded-lg' src="https://cdn.pixabay.com/photo/2020/12/27/12/07/sunrise-5863751_640.png" alt="logo" />
